    ...
    public Home() {
        ...
        try{
            if(TokenAuthenticationService.getToken() != null){
                String json = RestConn.getRestResponse("pacientes/".concat(TokenAuthenticationService.getCurp()), null);
                ...
                json = RestConn.getRestResponse("pacientes/".concat(TokenAuthenticationService.getCurp().concat("/todo_tomas_signos")), null);
