 ...
 * @author tulio_93
 */
public class WRecetas extends SearchWindow {
    ...
    public ListitemRenderer<?> getItemRenderer() {
        return (Listitem lstm, MReceta t, int i) -> {
    ...
    public Collection<?> getResults() {
        ...
        return gsonBuilder.create().fromJson(RestConn.getRestResponse("http://127.0.0.1:8000/pacientes/".concat(TokenAuthenticationService.getCurp().concat("/recetas"))), MReceta.LIST_TYPE);
    }
